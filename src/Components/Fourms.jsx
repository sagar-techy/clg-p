...
const Forums = () => {
 return (
 <section className="forums bg-gradient-to-r from-blue-500 to-purple-600 text-white py-16">
   <div className="container mx-auto px-4">
     ...
     <div className="forum-posts bg-white rounded-lg shadow-lg p-6 max-w-4xl mx-auto">
       <h3 className="text-3xl font-semibold text-blue-600 mb-8">Latest Discussions</h3>
       <div className="space-y-6">
         <article className="border-b border-gray-200 pb-6">
           ...
           <button className="bg-gradient-to-r from-blue-500 to-purple-600 text-white font-semibold py-2 px-4 rounded-full shadow-md hover:shadow-xl transition duration-300">View Discussion</button>
         </article>
