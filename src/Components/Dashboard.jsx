...
const Dashboard = () => {
  return (
    <section className="dashboard bg-[#F5F5F5] text-[#444040] py-16">
      <div className="container mx-auto px-4">
        ...
        <div className="mt-10 text-center">
          <button className=" bg-[#5f2509ca] text-white hover:text-black font-semibold py-2 px-6 rounded-full shadow-lg hover:bg-blue-100 transition duration-300">
